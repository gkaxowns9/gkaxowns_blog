...
먼저 Stable Diffusion 모델은 크게 3가지로 나눌 수 있다.
    1. Text Encoding 모델
    2. Diffusion (Reversed) 모델
    3. Image Decoding 모델
- 각 모델의 원리를 천천히 알아보자
...
![[출처](https://ffighting.net/deep-learning-paper-review/diffusion-model/stable-diffusion/)](897b433e-6cee-49a6-8aad-391738bfaa62.png)
